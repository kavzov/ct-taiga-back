...
docker run -d --name ct-taiga-back -p 8000:8000 --link postgres:postgres -v ct-taiga-psql-volume:/var/run -v ct-taiga-volume:/home/taiga -v /home/igor/ct-taiga/data/logs:/home/taiga/logs ct-taiga-back
